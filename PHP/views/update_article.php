...
elseif ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    if (isset($_POST['title']) && isset($_POST['url'])) 
    {
        ...
        $article = (new ArticleRepository())->updateArticle($articleiD, $articleTitle, $articleUrl);
...
<body class="h-full">
  ...
  <h2 class="mt-6 text-3xl tracking-tight font-bold text-gray-900" align="center">Update Article</h2>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input placeholder="A URL for your Article"
                           ...
                           type="text"
                           class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                           value= <?= isset($article) ? $article->url : '' ?>>
                </div>
            </div>
